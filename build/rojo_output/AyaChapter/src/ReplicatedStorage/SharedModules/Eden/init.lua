...
local function AddModule(pathData : PathData, module : ModuleScript, isStatic : boolean) : boolean
	if module:IsA("ModuleScript") then
		local newModuleData = {
			...
			AutoInitData = {
				Priority = 0,
				HasExplicitPriority = false, -- Dodaj wymagane pole
				First = nil -- Jeśli jest opcjonalne, możesz zostawić jako `nil` lub przypisać wartość domyślną
